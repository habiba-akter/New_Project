...
<head>
    <meta charset="utf-8" />
    <title>Metronic Admin Theme #2 | Admin Dashboard</title>
    ...
    <link href="{{asset('admin/assets/layouts/layout2/css/themes/blue.min.css')}}" rel="stylesheet" type="text/css" id="style_color" />
